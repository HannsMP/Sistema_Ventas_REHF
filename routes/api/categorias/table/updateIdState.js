...
module.exports = {
  load: true,
  route: "/api/categorias/table/updateIdState",
  post: [
    async function (req, res, next) {
      try {
        ...
        let OkPacket = await this.model.tb_categorias.updateIdState(Number(id), Number(estado));
        await this.model.tb_productos.updateStateCategoriaId(Number(id), Number(estado));
